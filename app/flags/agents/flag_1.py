...
class AgentsFlag1(Flag):
    ...
    challenge = (
        ...
        'the same as what is hosting the server (HINT: If running caldera on any flavor Linux, use a Windows or Mac for remote host.) '
        'It is OK to use a virtual box to complete this challenge.'
    )
