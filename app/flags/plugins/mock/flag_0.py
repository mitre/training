...
class PluginsMockFlag0(Flag):
    name = 'Mock plugin'
    challenge = 'Enable the mock plugin. Then run an operation against the "simulation" group using the Hunter profile. (Hint: check default.yml for running plugins)'
    extra_info = (
