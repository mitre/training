...
1. Scroll down the on the deployment options until you see the one labeled "Deploy as a blue-team agent instead of red". Click the `Copy` button to copy the displayed PowerShell command to your clipboard. This command will execute the agent in the `blue` group in the background.
