...
'\ncopy /y sandcat.go-windows\n\\\\#{remote.host.name}\\Users\\Public`. When the technique is selected (Lateral Tool Transfer), give it a score of `1`. Rename the layer `blue_quiz_5` and then download the layer in json format.
